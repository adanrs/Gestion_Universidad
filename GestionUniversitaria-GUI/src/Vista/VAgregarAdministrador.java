...
public class VAgregarAdministrador extends javax.swing.JFrame {

    public VAgregarAdministrador(Control c) {
        gestor = c;
    ...
    private void agregar() {
        if (vacio()) {
            ...
            gestor.agregarAdministrador(campoNombre.getText(), campoCed.getText(), aux, campoCorreo.getText(), campoClave.getText());
            salir();
        }
    }
